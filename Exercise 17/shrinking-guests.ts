...
let guests : string[] = ["Bilal", "Ubaid", "Ahmed", "Junaid", "Mustafa", "Ali"];

// Informing people about the limited space
console.log(
  "Attention: Due to limited space, we regret to inform you that our dinner plans have changed unexpectedly. we can only invite two people for dinner."
);
