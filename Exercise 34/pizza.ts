...
let favourite_pizzas : string[] = ["Pepperoni","Margherita","BBQ Chicken"];

// Loop through the array to print each pizza name
for(let favourite_pizza of favourite_pizzas){
...
console.log("Pizza is one my favourite foods.I really love pizza!");
